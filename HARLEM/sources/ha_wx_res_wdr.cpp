...
wxSizer *solvate_mset_dlg( wxWindow *parent, bool call_fit, bool set_sizer )
{
    ...
    wxStaticText *item8 = new wxStaticText( parent, ID_TEXT, wxT("Minimal Solute - Solvent Distance: "), wxDefaultPosition, wxDefaultSize, 0 );
    item7->Add( item8, 0, wxALIGN_CENTER|wxALL, 5 );

    wxTextCtrl *item9 = new wxTextCtrl( parent, IDC_MIN_SOLUTE_SOLV_DIST, wxT(""), wxDefaultPosition, wxSize(80,-1), 0 );
    ...
    wxButton *item11 = new wxButton( parent, IDC_SOLV_MOL, wxT("Solvate Molecules"), wxDefaultPosition, wxDefaultSize, 0 );
    item10->Add( item11, 0, wxALIGN_CENTER|wxALL, 5 );
    ...
    wxStaticText *item13 = new wxStaticText( parent, ID_TEXT, wxT("Num  Na+ ions: "), wxDefaultPosition, wxDefaultSize, 0 );
    item12->Add( item13, 0, wxALIGN_CENTER|wxALL, 5 );

    wxTextCtrl *item14 = new wxTextCtrl( parent, IDC_NUM_NA, wxT("0"), wxDefaultPosition, wxSize(80,-1), 0 );
    ...
    wxStaticText *item16 = new wxStaticText( parent, ID_TEXT, wxT("Num Cl- ions : "), wxDefaultPosition, wxDefaultSize, 0 );
    item15->Add( item16, 0, wxALIGN_CENTER|wxALL, 5 );

    wxTextCtrl *item17 = new wxTextCtrl( parent, IDC_NUM_CL, wxT("0"), wxDefaultPosition, wxSize(80,-1), 0 );
    item15->Add( item17, 1, wxALIGN_CENTER|wxALL, 5 );

    item0->Add( item15, 1, wxGROW|wxALIGN_CENTER_VERTICAL|wxALL, 0 );

    wxBoxSizer *item18 = new wxBoxSizer( wxHORIZONTAL );

    wxButton *item19 = new wxButton( parent, IDC_ADD_IONS, wxT("Add Ions"), wxDefaultPosition, wxDefaultSize, 0 );
    item18->Add( item19, 1, wxALIGN_CENTER|wxALL, 5 );

    wxButton *item20 = new wxButton( parent, IDC_CALC_NUM_IONS, wxT("Calc Num Ions"), wxDefaultPosition, wxDefaultSize, 0 );
    item18->Add( item20, 1, wxALIGN_CENTER|wxALL, 5 );
...
wxSizer *res_params_dlg( wxWindow *parent, bool call_fit, bool set_sizer )
{
    ...
    wxCheckBox *item9 = new wxCheckBox( parent, IDC_EDTRES_MUT_RES, wxT("Mutated Res"), wxDefaultPosition, wxDefaultSize, 0 );
    ...
    wxButton *item12 = new wxButton( parent, IDC_EDTRES_UPDATE_RESLIST, wxT("Update Residue List"), wxDefaultPosition, wxDefaultSize, 0 );
    ...
    wxStaticText *item16 = new wxStaticText( parent, ID_TEXT, wxT("Selected Residue: "), wxDefaultPosition, wxDefaultSize, 0 );
    item15->Add( item16, 0, wxALIGN_CENTER|wxALL, 5 );

    wxTextCtrl *item17 = new wxTextCtrl( parent, IDC_RESPAR_SELECTED_RES, wxT(""), wxDefaultPosition, wxSize(300,-1), 0 );
    item15->Add( item17, 0, wxALIGN_CENTER|wxALL, 5 );

    item10->Add( item15, 0, wxALIGN_CENTER_VERTICAL|wxALL, 0 );

    wxBoxSizer *item18 = new wxBoxSizer( wxHORIZONTAL );

    wxButton *item19 = new wxButton( parent, IDC_RESPAR_MUTATE_RES, wxT("Mutate In Place to: "), wxDefaultPosition, wxDefaultSize, 0 );
    item18->Add( item19, 0, wxALIGN_CENTER|wxALL, 5 );

    wxButton *item20 = new wxButton( parent, IDC_RESPAR_SET_TRANSFORMATION, wxT("Set Alchemical Transformation to:"), wxDefaultPosition, wxDefaultSize, 0 );
    item18->Add( item20, 0, wxALIGN_CENTER|wxALL, 5 );

    wxTextCtrl *item21 = new wxTextCtrl( parent, IDC_RESPAR_MUTATED_RES_TYPE, wxT(""), wxDefaultPosition, wxSize(120,-1), 0 );
    item18->Add( item21, 0, wxALIGN_CENTER|wxALL, 5 );

    item10->Add( item18, 0, wxALIGN_CENTER_VERTICAL|wxALL, 0 );

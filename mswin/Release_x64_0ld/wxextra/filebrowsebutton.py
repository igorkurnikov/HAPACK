...
#
# RCS-ID:      $Id: filebrowsebutton.py 71987 2012-07-09 16:21:57Z KO $
...
class FileBrowseButton(wx.Panel):
    ...
    def createDialog( self, parent, id, pos, size, style, name ):
        ...
        box.Add( self.browseButton, 0, wx.LEFT|wx.CENTER, 0)
...
#            self.SetSize(size)
    ...
    def createBrowseButton( self):
        ...
        button =wx.Button(self, -1, self.buttonText,style=wx.BU_EXACTFIT)

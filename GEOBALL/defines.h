 ...
 * your preferences.
 * The original Alphavol is set for up to 10000 atoms
 *
 ***********************************************************************/
...
/* 
 * The number of edges is arbitrarily set to 10 times the number of atoms.
 * This works well for molecules, but it may fail for other objects
 * Similarly,
 *      - the number of triangles (faces) is set to 10 * MAX_ATOM
	- the number of tetrahedra is set to 5 * MAX_ATOM
 */

#ifndef MAX_EDGE
#define MAX_EDGE (20 * MAX_POINT)
#endif

#ifndef MAX_TRIG
#define MAX_TRIG (20 * MAX_POINT)
#endif

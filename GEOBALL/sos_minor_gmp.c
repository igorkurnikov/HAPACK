...
extern "C"
#endif
void F77Name2(transfer_all_to_gmp)(double *coord, double *radius, double *scale, int *nvertex);

#ifdef __cplusplus
extern "C"
#endif
void F77Name2(transfer_one_to_gmp)(double *coord, double *radius, double *scale, int *nvertex);
...
//void _sos_minor5_gmp(int *a, int *b, int *c, int *d, int *e, int *res);

...
if(script_status == SCRIPT_START): #  Script initialization
  ...
  print(" time   tot_ene    pot_ene    kin_ene  temperature", file=outf)
...
#  When MD trajectory analysis is complete the output file is closed.
  ...
  print("%6.3f %9.3f %9.3f %9.3f %9.3f" %  (t, mm_info.tot_energy, mm_info.pot_ene, mm_info.kin_ene, mm_info.temp), file=outf)

...
mset_1 = HaMolSet()
mset_2 = HaMolSet()
mset_1.LoadHarlemFile("dtt_mhis_1.hlm")
mset_2.LoadHarlemFile("dtt_h57p_1.hlm")
mset_1.SetName("dtt_h57_ti")
...
#p_mm_mod_1.LoadAmberRestartFile("dtt_h172_lmb_05_t278.rst")

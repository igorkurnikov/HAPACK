...
! indices into 1D arrays.
  ...
  type dist_constr_rec
    integer               :: atm_i
    integer               :: atm_j
    double precision      :: acoef
    double precision      :: bcoef
	integer               :: cnt_type    !type of atom -atom distance contraints if 0 - HARMONIC, 1- 6-12, 2 - 10-12, 3 - 6-12 NO Repulsion
  end type dist_constr_rec

  integer, parameter    :: nb_constr_rec_ints = 7    ! don't use for allocation!
